...
const translations = {
    vi: {
        ...
        'form.university': 'Trường đại học', 'form.university.ph': 'Đại học Kinh tế TP.HCM',
        'form.major': 'Chuyên ngành', 'form.major.ph': 'Tài chính / Kế toán / SCM...',
        ...
        'form.location': 'Khu vực làm việc mong muốn', 'form.location.both': 'Cả hai',
        'form.cv.placeholder': 'Kéo thả hoặc <strong>click để chọn file</strong>',
        'form.cv.hint': 'PDF, DOC, DOCX – Tối đa 5MB',
        'form.motivation': 'Tại sao bạn muốn gia nhập Wilmar CLV?',
        'form.motivation.ph': 'Chia sẻ động lực và mong muốn của bạn...',
    ...
    en: {
        ...
        'form.university': 'University', 'form.university.ph': 'University of Economics HCMC',
        'form.major': 'Major', 'form.major.ph': 'Finance / Accounting / SCM...',
        ...
        'form.location': 'Preferred work location', 'form.location.both': 'Both',
        'form.cv.placeholder': 'Drag & drop or <strong>click to select file</strong>',
        'form.cv.hint': 'PDF, DOC, DOCX – Max 5MB',
        'form.motivation': 'Why do you want to join Wilmar CLV?',
        'form.motivation.ph': 'Share your motivation and aspirations...',
